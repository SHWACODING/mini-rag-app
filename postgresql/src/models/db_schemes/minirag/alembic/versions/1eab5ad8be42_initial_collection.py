...
Revision ID: 1eab5ad8be42
Revises: 
Create Date: 2025-08-24 02:11:54.505629
...
def upgrade() -> None:
    ...
    op.create_index('idx_chunk_asset_id', 'data_chunks', ['chunk_asset_id'], unique=False)
    op.create_index('idx_chunk_project_id', 'data_chunks', ['chunk_project_id'], unique=False)
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index('idx_chunk_project_id', table_name='data_chunks')
    op.drop_index('idx_chunk_asset_id', table_name='data_chunks')
