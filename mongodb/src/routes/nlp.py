...
async def index_project(request: Request, project_id: str, push_request: PushRequestSchema):
    ...
    while has_records:
        page_chunks = await chunk_model.get_chunks_by_project_id(project_id=project.id, page_num=page_num)
